/**********************************************************************
* $Id$		hitex1850_board.c			2011-11-20
*//**
* @file		hitex1850_board.c
* @brief	Board specific functions for the HITEX1850 board
* @version	1.0
* @date		20. Nov. 2011
 ...
 *
 *  This function sets up the LED and ethernet pin muxing for the LPC1850
