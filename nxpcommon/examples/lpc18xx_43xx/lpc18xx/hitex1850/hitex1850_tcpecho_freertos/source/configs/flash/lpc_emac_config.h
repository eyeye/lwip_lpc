...
/** @defgroup hitex1850_tcpecho_freertos_flash	LWIP EMAC/PHY configuration
 ...
 */
#define LPC_NUM_BUFF_RXDESCS 10

/** \brief  Defines the number of descriptors used for TX
 */
#define LPC_NUM_BUFF_TXDESCS 10
 ...
 */
#define LPC_SLOWMEM_ARRAY {{0x1C000000, (0x1C000000 + (4 * 1024 * 1024) - 1)}}
