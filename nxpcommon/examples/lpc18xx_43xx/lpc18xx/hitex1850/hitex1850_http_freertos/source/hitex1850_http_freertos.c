/**********************************************************************
* $Id$		hitex1850_http_freertos.c			2011-11-20
*//**
* @file		hitex1850_http_freertos.c
* @brief	RTOS based HTTP server app
* @version	1.0
* @date		20. Nov. 2011
...
/** @defgroup hitex1850_http_freertos	HTTP server with RTOS
 * @ingroup HITEX1850
 *
 * This example shows how to use a HTTP server integrated with FreeRTOS.
 * @{
 */
