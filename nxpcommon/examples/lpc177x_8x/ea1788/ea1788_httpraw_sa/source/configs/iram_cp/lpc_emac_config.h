 ...
 */
#define LPC_PBUF_RX_ZEROCOPY 0 /**< Set to '1' to use zero-copy pbufs for receive. */
 ...
 */
#define LPC_PBUF_TX_ZEROCOPY 0 /**< Set to '1' to use no-copy pbufs for transmit. */
