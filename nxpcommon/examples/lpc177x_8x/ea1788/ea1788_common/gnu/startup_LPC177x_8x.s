...
/* Reset Handler */
    ...
    .globl  __bss_early_start, __bss_early_end, __bss_start__, __bss_end__
    .globl  __data_early_start, __data_early_end, __data_start__, __data_end__
	.globl  __data_early_placement, __data_placement, __data_early_load, __data_load
...
__cs3_reset_cortex_m:
    .fnstart
/* Clear early .bss section in IRAM needed for early init */
	LDR     R0, =__bss_early_start
	LDR     R1, =__bss_early_end
	BL 		clear_bss
/* Relocate early data segment in IRAM needed for early init */
	LDR     R0, =__data_early_start
	LDR     R1, =__data_early_end
	LDR     R2, =__data_early_load
	BL 		data_copy

/* System, clock, and DRAM init */
    LDR     R0, =SystemInit
    BLX     R0
    LDR     R0, =SDRAMInit
    BLX     R0
